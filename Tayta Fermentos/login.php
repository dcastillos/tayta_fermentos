				...
				<div class="col-md-7">
					<div class="contact-wrap w-100 p-md-5 p-4 text-center mx-auto">
						...
						<div class="mb-4">
							...
							<div class="row">
								<div class="col mb-2">
									<button type="button" class="btn btn-danger btn-block mx-auto" style="max-width: 300px;">
						...
						<p class="mt-4">¿No tienes una cuenta? <a href="#!" class="text-primary">Regístrate</a></p>
					</div>
				</div>
			</div>
		</div>
