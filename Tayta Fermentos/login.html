      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            <h2 class="mb-0 bread">Iniciar Sesión</h2>
          </div>
        </div>
      </div>
    </section>
								...
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form>
											...
											<!-- Submit button -->
											<button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4">Ingresar</button>
