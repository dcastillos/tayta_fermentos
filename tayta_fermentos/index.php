...
<html lang="en">
  ...
  <?php include('header.php'); ?>   
	...
	<!--carrusel-->
	<div class="carrusel_tayta d-flex justify-content-center">
		<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<picture>
						<!-- Imagen para móviles -->
						<source srcset="images/Banners_Inicio1_cuadrado_cel.jpg" media="(max-width: 768px)">
						<!-- Imagen por defecto para PC -->
						<img src="images/Banners Inicio1(1).jpg" class="d-block w-100" alt="Tayta Fermentos">
					</picture>
				</div>
				<div class="carousel-item">
					<picture>
						...
						<source srcset="images/Banners_Inicio1_cuadrado_cel.jpg" media="(max-width: 768px)">
						<!-- Imagen por defecto para PC -->
						<img src="images/Banners Inicio1.jpg" class="d-block w-100" alt="Tayta Fermentos">
					</picture>
				</div>
				<div class="carousel-item">
					<picture>
						<!-- Imagen para móviles -->
						<source srcset="images/Banners_Inicio2_cuadrado_cel.jpg" media="(max-width: 768px)">
						<!-- Imagen por defecto para PC -->
						<img src="images/Banners Inicio2.jpg" class="d-block w-100" alt="Tayta Fermentos">
					</picture>
				</div>
				<div class="carousel-item">
					<picture>
						<!-- Imagen para móviles -->
						<source srcset="images/Banners_Inicio3_cuadrado_cel.jpg" media="(max-width: 768px)">
						<!-- Imagen por defecto para PC -->
						<img src="images/Banners Inicio3.jpg" class="d-block w-100" alt="Tayta Fermentos">
					</picture>
				</div>
				<div class="carousel-item">
					<picture>
						<!-- Imagen para móviles -->
						<source srcset="images/Banners_Inicio4_cuadrado_cel.jpg" media="(max-width: 768px)">
						<!-- Imagen por defecto para PC -->
						<img src="images/Banners Inicio4.jpg" class="d-block w-100" alt="Tayta Fermentos">
					</picture>
				</div>
			</div>
    		...
    		<div class="row no-gutters">
    			<div class="col-md-4 d-flex">
    				<div class="intro d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
    						<h2 style="font-family: 'BebasNeue', sans-serif; text-align: center">DESCUBRE NUESTROS TALLERES</h2>
    						<p style="font-family: 'RobotoLight', sans-serif; text-align: center">En nuestros talleres, te invitamos a descubrir el fascinante mundo de los alimentos PROBIÓTICOS. Aprende de manera práctica cómo elaborarlos utilizando ingredientes naturales y técnicas simples y muy eficientes. Nuestro chef experto Riders Rosini te guiará paso a paso en cada proceso de fermentación, brindándote las herramientas para crear alimentos vivos que mejoran tu salud intestinal y tu bienestar general.</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4 d-flex">
    			...
    			<div class="col-md-4 d-flex">
    				<div class="intro color-2 d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
    						<h2 style="font-family: 'BebasNeue', sans-serif; text-align: center">DELIVERY</h2>
    						<p style="font-family: 'RobotoLight', sans-serif; text-align: center">Pide tus productos probióticos favoritos, como kombucha, kimchi, chucrut y ginger beer, y muchos otros más. Recíbelos directamente en la comodidad de tu hogar. Nos aseguramos de que cada entrega mantenga la frescura y calidad que nos caracteriza, permitiéndote disfrutar de los beneficios de los alimentos fermentados sin salir de casa.</p>
    					</div>
    				</div>
    			</div>
    		</div>
    ...
    <section class="ftco-section testimony-section img" style="background-image: url(images/salud_tayta.jpeg);">
